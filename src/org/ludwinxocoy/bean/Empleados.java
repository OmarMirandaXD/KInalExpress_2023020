...
public class Empleados {
    ...
    public Empleados(int codigoEmpleado, String nombresEmpleado, String apellidosEmpleado, double sueldo, String direccion, String turno, int CargoEmpleado_codigoCargoEmpleado) {
